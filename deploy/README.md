...
Ready-to-copy configuration for the three deployment topologies covered
...
| _(repo root)_ `fly.toml` + `Dockerfile` | Combined node + walletd in one fly machine | You want a turnkey hosted deployment |
